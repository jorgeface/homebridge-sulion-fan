...
import { SulionFanAccessory } from './platformAccessory.js';
 ...
 */
export class HomebridgeSulionFanPlatform implements DynamicPlatformPlugin {
  ...
  discoverDevices(fans: FanConfiguration[]) {
    ...
    for (const device of fans) {
      ...
      if (existingAccessory) {
        ...
        new SulionFanAccessory(this, existingAccessory);
        ...
        // this is imported from `platformAccessory.ts`
        new SulionFanAccessory(this, accessory);
